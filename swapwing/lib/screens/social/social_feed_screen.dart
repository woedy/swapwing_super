...
class SocialJourneyCard extends StatelessWidget {
      ...
      child: Container(
        ...
        child: Stack(
          children: [
            ...
            Positioned.fill(
              child: JourneyProgressVisualization(journey: journey),
            ),
            ...
            Positioned(
              ...
              left: 16,
              right: 80,
              child: UserHeader(journey: journey),
            ),
            ...
            Positioned(
              ...
              left: 16,
              right: 80,
              child: JourneyInfo(journey: journey),
            ),
...
class JourneyProgressVisualization extends StatelessWidget {
  final TradeJourney journey;

  const JourneyProgressVisualization({
    super.key,
    required this.journey,
  });
...
class UserHeader extends StatelessWidget {
  ...
  const UserHeader({super.key, required this.journey});
...
class JourneyInfo extends StatelessWidget {
  ...
  const JourneyInfo({super.key, required this.journey});
